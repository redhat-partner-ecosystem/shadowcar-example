...
package hono.telemetry.amqp.vertx.example;

import hono.telemetry.amqp.vertx.example.base.HonoExampleApplicationBase;
 ...
 * to which to connect.
 */
public class App extends HonoExampleApplicationBase {
